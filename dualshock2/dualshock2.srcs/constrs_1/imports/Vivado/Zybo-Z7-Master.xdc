...
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33   PULLUP true } [get_ports { jc4 }]; #IO_L8P_T1_34 Sch=jc_p[3]
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33   PULLUP true } [get_ports { jc5 }]; #IO_L8N_T1_34 Sch=jc_n[3]
